package com.github.iryabov.dronedelivery.client;

import com.github.iryabov.dronedelivery.client.impl.StubDroneClient;
...
public class DroneEmulatorTest {
    ...
    void simpleDelivery() {
        ...
        drone.flyTo(new DroneClient.Point(10, -10));
